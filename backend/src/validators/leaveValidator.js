/**
 * Leave Validators
 * Input validation and sanitization rules for leave related operations.
 ...
 */
function validateLeaveBusinessRules(data, operation = 'create') {
  const errors = [];
 ...
 */
function sanitizeLeavePayload(payload) {
...
module.exports = {
  ...
  validate,
  validateLeaveBusinessRules,
  sanitizeLeavePayload
};
