/**
 * Payroll Validators
 * Input validation and sanitization rules for payroll related operations.
 ...
 */
function validatePayrollBusinessRules(data, operation = 'create') {
  const errors = [];
 ...
 */
function sanitizePayrollPayload(payload) {
