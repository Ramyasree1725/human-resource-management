 ...
 * Input validation and sanitization rules for performance related operations.
 ...
 */
function validatePerformanceBusinessRules(data, operation = 'create') {
  const errors = [];
 ...
 */
function sanitizePerformancePayload(payload) {
...
module.exports = {
  ...
  validate,
  validatePerformanceBusinessRules,
