 ...
 * Input validation and sanitization rules for attendance related operations.
 ...
 */
function validateAttendanceBusinessRules(data, operation = 'create') {
  const errors = [];
...
module.exports = {
  ...
  validate,
  validateAttendanceBusinessRules,
