/**
 * Asset Service
 * Business logic layer for asset management in the Employee Management System.
...
class AssetService {
  ...
  /**
   * Retrieve all asset records with optional filtering, sorting and pagination.
  ...
  /**
   * Find a single asset by its unique identifier.
   */
  async findById(id) {
    ...
    if (!record) {
      return { success: false, message: 'Asset not found', statusCode: 404 };
    }
  ...
  /**
   * Create a new asset record after running full validation and business rules.
   */
  ...
  /**
   * Soft or hard delete a asset record.
   */
