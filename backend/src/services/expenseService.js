/**
 * Expense Service
 * Business logic layer for expense management in the Employee Management System.
...
class ExpenseService {
  ...
  /**
   * Retrieve all expense records with optional filtering, sorting and pagination.
  ...
  /**
   * Find a single expense by its unique identifier.
   */
  async findById(id) {
  ...
  /**
   * Create a new expense record after running full validation and business rules.
   */
  ...
  /**
   * Soft or hard delete a expense record.
   */
  async remove(id, actor = null, hard = false) {
    ...
    return { success: true, message: 'Expense removed successfully' };
  }
