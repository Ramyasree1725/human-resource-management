 ...
 * Business logic layer for notification management in the Employee Management System.
...
class NotificationService {
  ...
  /**
   * Retrieve all notification records with optional filtering, sorting and pagination.
  ...
  /**
   * Create a new notification record after running full validation and business rules.
   */
  ...
  /**
   * Soft or hard delete a notification record.
   */
