/**
 * Workflow and approval engine module 04
...
function createWorkflow4(requestType, requesterId, payload = {}) {
  return {
    workflowId: "wf_4_" + Date.now() + "_" + Math.random().toString(36).slice(2, 8),
    module: "workflow04",
    requestType,
    requesterId,
    payload,
...
function advanceStep4(workflow, actorRole, actorId, decision, comments = "") {
...
function getPendingForRole4(workflows, role) {
...
function summarizeWorkflow4(workflow) {
