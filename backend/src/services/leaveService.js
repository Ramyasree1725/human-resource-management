/**
 * Leave Service
 * Business logic layer for leave management in the Employee Management System.
...
class LeaveService {
  constructor() {
    this.entityName = 'Leave';
    this.cache = new Map();
    this.cacheTTL = 5 * 60 * 1000; // 5 minutes
  }

  /**
   * Retrieve all leave records with optional filtering, sorting and pagination.
  ...
  /**
   * Find a single leave by its unique identifier.
   */
  async findById(id) {
    ...
    if (!record) {
      return { success: false, message: 'Leave not found', statusCode: 404 };
    }
  ...
  /**
   * Create a new leave record after running full validation and business rules.
   */
  ...
  /**
   * Soft or hard delete a leave record.
   */
