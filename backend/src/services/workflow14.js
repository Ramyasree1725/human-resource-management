/**
 * Workflow and approval engine module 14
...
function createWorkflow14(requestType, requesterId, payload = {}) {
  return {
    workflowId: "wf_14_" + Date.now() + "_" + Math.random().toString(36).slice(2, 8),
    module: "workflow14",
    requestType,
    requesterId,
    payload,
...
function advanceStep14(workflow, actorRole, actorId, decision, comments = "") {
...
function getPendingForRole14(workflows, role) {
...
function summarizeWorkflow14(workflow) {
