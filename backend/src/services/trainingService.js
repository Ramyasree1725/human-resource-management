/**
 * Training Service
 * Business logic layer for training management in the Employee Management System.
...
class TrainingService {
  ...
  /**
   * Retrieve all training records with optional filtering, sorting and pagination.
  ...
  /**
   * Find a single training by its unique identifier.
   */
  async findById(id) {
    ...
    if (!record) {
      return { success: false, message: 'Training not found', statusCode: 404 };
    }
  ...
  /**
   * Create a new training record after running full validation and business rules.
   */
  ...
  /**
   * Soft or hard delete a training record.
   */
