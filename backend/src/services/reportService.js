/**
 * Report Service
 * Business logic layer for report management in the Employee Management System.
...
class ReportService {
  ...
  /**
   * Retrieve all report records with optional filtering, sorting and pagination.
  ...
  /**
   * Find a single report by its unique identifier.
   */
  async findById(id) {
  ...
  /**
   * Create a new report record after running full validation and business rules.
   */
  ...
  /**
   * Soft or hard delete a report record.
   */
