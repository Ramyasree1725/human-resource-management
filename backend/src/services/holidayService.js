/**
 * Holiday Service
 * Business logic layer for holiday management in the Employee Management System.
...
class HolidayService {
  ...
  /**
   * Retrieve all holiday records with optional filtering, sorting and pagination.
  ...
  /**
   * Find a single holiday by its unique identifier.
   */
  async findById(id) {
    ...
    if (!record) {
      return { success: false, message: 'Holiday not found', statusCode: 404 };
    }
  ...
  /**
   * Create a new holiday record after running full validation and business rules.
   */
  ...
  /**
   * Soft or hard delete a holiday record.
   */
