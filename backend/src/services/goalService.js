/**
 * Goal Service
 * Business logic layer for goal management in the Employee Management System.
...
class GoalService {
  ...
  /**
   * Retrieve all goal records with optional filtering, sorting and pagination.
  ...
  /**
   * Find a single goal by its unique identifier.
   */
  async findById(id) {
  ...
  /**
   * Create a new goal record after running full validation and business rules.
   */
  ...
  /**
   * Soft or hard delete a goal record.
   */
