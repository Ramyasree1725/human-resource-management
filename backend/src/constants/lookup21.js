/**
 * Lookup table and configuration module 21
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_21 = {
  categories: [
    { id: "cat_21_01", name: "Category A21", weight: 1.0, active: true },
    { id: "cat_21_02", name: "Category B21", weight: 1.2, active: true },
    { id: "cat_21_03", name: "Category C21", weight: 0.8, active: true },
    { id: "cat_21_04", name: "Category D21", weight: 1.5, active: false },
    { id: "cat_21_05", name: "Category E21", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory21(id) {
  return LOOKUP_21.categories.find(c => c.id === id) || null;
}

function getScoreLabel21(score) {
  const s = LOOKUP_21.scores;
...
function getSalaryBand21(salary) {
  return LOOKUP_21.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons21() {
  return [...LOOKUP_21.reasons];
}
