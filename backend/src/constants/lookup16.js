/**
 * Lookup table and configuration module 16
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_16 = {
  categories: [
    { id: "cat_16_01", name: "Category A16", weight: 1.0, active: true },
    { id: "cat_16_02", name: "Category B16", weight: 1.2, active: true },
    { id: "cat_16_03", name: "Category C16", weight: 0.8, active: true },
    { id: "cat_16_04", name: "Category D16", weight: 1.5, active: false },
    { id: "cat_16_05", name: "Category E16", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory16(id) {
  return LOOKUP_16.categories.find(c => c.id === id) || null;
}

function getScoreLabel16(score) {
  const s = LOOKUP_16.scores;
...
function getSalaryBand16(salary) {
  return LOOKUP_16.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons16() {
  return [...LOOKUP_16.reasons];
}
