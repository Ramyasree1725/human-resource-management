/**
 * Lookup table and configuration module 09
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_09 = {
  categories: [
    { id: "cat_9_01", name: "Category A9", weight: 1.0, active: true },
    { id: "cat_9_02", name: "Category B9", weight: 1.2, active: true },
    { id: "cat_9_03", name: "Category C9", weight: 0.8, active: true },
    { id: "cat_9_04", name: "Category D9", weight: 1.5, active: false },
    { id: "cat_9_05", name: "Category E9", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory9(id) {
  return LOOKUP_09.categories.find(c => c.id === id) || null;
}

function getScoreLabel9(score) {
  const s = LOOKUP_09.scores;
...
function getSalaryBand9(salary) {
  return LOOKUP_09.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons9() {
  return [...LOOKUP_09.reasons];
}
