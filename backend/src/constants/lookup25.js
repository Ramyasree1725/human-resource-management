/**
 * Lookup table and configuration module 25
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_25 = {
  categories: [
    { id: "cat_25_01", name: "Category A25", weight: 1.0, active: true },
    { id: "cat_25_02", name: "Category B25", weight: 1.2, active: true },
    { id: "cat_25_03", name: "Category C25", weight: 0.8, active: true },
    { id: "cat_25_04", name: "Category D25", weight: 1.5, active: false },
    { id: "cat_25_05", name: "Category E25", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory25(id) {
  return LOOKUP_25.categories.find(c => c.id === id) || null;
}

function getScoreLabel25(score) {
  const s = LOOKUP_25.scores;
...
function getSalaryBand25(salary) {
  return LOOKUP_25.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons25() {
  return [...LOOKUP_25.reasons];
}
