/**
 * Lookup table and configuration module 12
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_12 = {
  categories: [
    { id: "cat_12_01", name: "Category A12", weight: 1.0, active: true },
    { id: "cat_12_02", name: "Category B12", weight: 1.2, active: true },
    { id: "cat_12_03", name: "Category C12", weight: 0.8, active: true },
    { id: "cat_12_04", name: "Category D12", weight: 1.5, active: false },
    { id: "cat_12_05", name: "Category E12", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory12(id) {
  return LOOKUP_12.categories.find(c => c.id === id) || null;
}

function getScoreLabel12(score) {
  const s = LOOKUP_12.scores;
...
function getSalaryBand12(salary) {
  return LOOKUP_12.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons12() {
  return [...LOOKUP_12.reasons];
}
