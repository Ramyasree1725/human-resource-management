/**
 * Lookup table and configuration module 18
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_18 = {
  categories: [
    { id: "cat_18_01", name: "Category A18", weight: 1.0, active: true },
    { id: "cat_18_02", name: "Category B18", weight: 1.2, active: true },
    { id: "cat_18_03", name: "Category C18", weight: 0.8, active: true },
    { id: "cat_18_04", name: "Category D18", weight: 1.5, active: false },
    { id: "cat_18_05", name: "Category E18", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory18(id) {
  return LOOKUP_18.categories.find(c => c.id === id) || null;
}

function getScoreLabel18(score) {
  const s = LOOKUP_18.scores;
...
function getSalaryBand18(salary) {
  return LOOKUP_18.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons18() {
  return [...LOOKUP_18.reasons];
}
