/**
 * Lookup table and configuration module 30
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_30 = {
  categories: [
    { id: "cat_30_01", name: "Category A30", weight: 1.0, active: true },
    { id: "cat_30_02", name: "Category B30", weight: 1.2, active: true },
    { id: "cat_30_03", name: "Category C30", weight: 0.8, active: true },
    { id: "cat_30_04", name: "Category D30", weight: 1.5, active: false },
    { id: "cat_30_05", name: "Category E30", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory30(id) {
  return LOOKUP_30.categories.find(c => c.id === id) || null;
}

function getScoreLabel30(score) {
  const s = LOOKUP_30.scores;
...
function getSalaryBand30(salary) {
  return LOOKUP_30.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons30() {
  return [...LOOKUP_30.reasons];
}
