/**
 * Lookup table and configuration module 08
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_08 = {
  categories: [
    { id: "cat_8_01", name: "Category A8", weight: 1.0, active: true },
    { id: "cat_8_02", name: "Category B8", weight: 1.2, active: true },
    { id: "cat_8_03", name: "Category C8", weight: 0.8, active: true },
    { id: "cat_8_04", name: "Category D8", weight: 1.5, active: false },
    { id: "cat_8_05", name: "Category E8", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory8(id) {
  return LOOKUP_08.categories.find(c => c.id === id) || null;
}

function getScoreLabel8(score) {
  const s = LOOKUP_08.scores;
...
function getSalaryBand8(salary) {
  return LOOKUP_08.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons8() {
  return [...LOOKUP_08.reasons];
}
