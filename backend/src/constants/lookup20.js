/**
 * Lookup table and configuration module 20
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_20 = {
  categories: [
    { id: "cat_20_01", name: "Category A20", weight: 1.0, active: true },
    { id: "cat_20_02", name: "Category B20", weight: 1.2, active: true },
    { id: "cat_20_03", name: "Category C20", weight: 0.8, active: true },
    { id: "cat_20_04", name: "Category D20", weight: 1.5, active: false },
    { id: "cat_20_05", name: "Category E20", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory20(id) {
  return LOOKUP_20.categories.find(c => c.id === id) || null;
}

function getScoreLabel20(score) {
  const s = LOOKUP_20.scores;
...
function getSalaryBand20(salary) {
  return LOOKUP_20.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons20() {
  return [...LOOKUP_20.reasons];
}
