/**
 * Lookup table and configuration module 04
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_04 = {
  categories: [
    { id: "cat_4_01", name: "Category A4", weight: 1.0, active: true },
    { id: "cat_4_02", name: "Category B4", weight: 1.2, active: true },
    { id: "cat_4_03", name: "Category C4", weight: 0.8, active: true },
    { id: "cat_4_04", name: "Category D4", weight: 1.5, active: false },
    { id: "cat_4_05", name: "Category E4", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory4(id) {
  return LOOKUP_04.categories.find(c => c.id === id) || null;
}

function getScoreLabel4(score) {
  const s = LOOKUP_04.scores;
...
function getSalaryBand4(salary) {
  return LOOKUP_04.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons4() {
  return [...LOOKUP_04.reasons];
}
