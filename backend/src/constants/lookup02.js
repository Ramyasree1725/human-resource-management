/**
 * Lookup table and configuration module 02
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_02 = {
  categories: [
    { id: "cat_2_01", name: "Category A2", weight: 1.0, active: true },
    { id: "cat_2_02", name: "Category B2", weight: 1.2, active: true },
    { id: "cat_2_03", name: "Category C2", weight: 0.8, active: true },
    { id: "cat_2_04", name: "Category D2", weight: 1.5, active: false },
    { id: "cat_2_05", name: "Category E2", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory2(id) {
  return LOOKUP_02.categories.find(c => c.id === id) || null;
}

function getScoreLabel2(score) {
  const s = LOOKUP_02.scores;
...
function getSalaryBand2(salary) {
  return LOOKUP_02.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons2() {
  return [...LOOKUP_02.reasons];
}
