/**
 * Lookup table and configuration module 15
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_15 = {
  categories: [
    { id: "cat_15_01", name: "Category A15", weight: 1.0, active: true },
    { id: "cat_15_02", name: "Category B15", weight: 1.2, active: true },
    { id: "cat_15_03", name: "Category C15", weight: 0.8, active: true },
    { id: "cat_15_04", name: "Category D15", weight: 1.5, active: false },
    { id: "cat_15_05", name: "Category E15", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory15(id) {
  return LOOKUP_15.categories.find(c => c.id === id) || null;
}

function getScoreLabel15(score) {
  const s = LOOKUP_15.scores;
...
function getSalaryBand15(salary) {
  return LOOKUP_15.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons15() {
  return [...LOOKUP_15.reasons];
}
