/**
 * Lookup table and configuration module 24
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_24 = {
  categories: [
    { id: "cat_24_01", name: "Category A24", weight: 1.0, active: true },
    { id: "cat_24_02", name: "Category B24", weight: 1.2, active: true },
    { id: "cat_24_03", name: "Category C24", weight: 0.8, active: true },
    { id: "cat_24_04", name: "Category D24", weight: 1.5, active: false },
    { id: "cat_24_05", name: "Category E24", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory24(id) {
  return LOOKUP_24.categories.find(c => c.id === id) || null;
}

function getScoreLabel24(score) {
  const s = LOOKUP_24.scores;
...
function getSalaryBand24(salary) {
  return LOOKUP_24.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons24() {
  return [...LOOKUP_24.reasons];
}
