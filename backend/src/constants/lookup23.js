/**
 * Lookup table and configuration module 23
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_23 = {
  categories: [
    { id: "cat_23_01", name: "Category A23", weight: 1.0, active: true },
    { id: "cat_23_02", name: "Category B23", weight: 1.2, active: true },
    { id: "cat_23_03", name: "Category C23", weight: 0.8, active: true },
    { id: "cat_23_04", name: "Category D23", weight: 1.5, active: false },
    { id: "cat_23_05", name: "Category E23", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory23(id) {
  return LOOKUP_23.categories.find(c => c.id === id) || null;
}

function getScoreLabel23(score) {
  const s = LOOKUP_23.scores;
...
function getSalaryBand23(salary) {
  return LOOKUP_23.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons23() {
  return [...LOOKUP_23.reasons];
}
