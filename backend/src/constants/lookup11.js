/**
 * Lookup table and configuration module 11
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_11 = {
  categories: [
    { id: "cat_11_01", name: "Category A11", weight: 1.0, active: true },
    { id: "cat_11_02", name: "Category B11", weight: 1.2, active: true },
    { id: "cat_11_03", name: "Category C11", weight: 0.8, active: true },
    { id: "cat_11_04", name: "Category D11", weight: 1.5, active: false },
    { id: "cat_11_05", name: "Category E11", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory11(id) {
  return LOOKUP_11.categories.find(c => c.id === id) || null;
}

function getScoreLabel11(score) {
  const s = LOOKUP_11.scores;
...
function getSalaryBand11(salary) {
  return LOOKUP_11.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons11() {
  return [...LOOKUP_11.reasons];
}
