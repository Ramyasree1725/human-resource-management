/**
 * Lookup table and configuration module 22
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_22 = {
  categories: [
    { id: "cat_22_01", name: "Category A22", weight: 1.0, active: true },
    { id: "cat_22_02", name: "Category B22", weight: 1.2, active: true },
    { id: "cat_22_03", name: "Category C22", weight: 0.8, active: true },
    { id: "cat_22_04", name: "Category D22", weight: 1.5, active: false },
    { id: "cat_22_05", name: "Category E22", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory22(id) {
  return LOOKUP_22.categories.find(c => c.id === id) || null;
}

function getScoreLabel22(score) {
  const s = LOOKUP_22.scores;
...
function getSalaryBand22(salary) {
  return LOOKUP_22.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons22() {
  return [...LOOKUP_22.reasons];
}
