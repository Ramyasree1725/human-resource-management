/**
 * Lookup table and configuration module 29
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_29 = {
  categories: [
    { id: "cat_29_01", name: "Category A29", weight: 1.0, active: true },
    { id: "cat_29_02", name: "Category B29", weight: 1.2, active: true },
    { id: "cat_29_03", name: "Category C29", weight: 0.8, active: true },
    { id: "cat_29_04", name: "Category D29", weight: 1.5, active: false },
    { id: "cat_29_05", name: "Category E29", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory29(id) {
  return LOOKUP_29.categories.find(c => c.id === id) || null;
}

function getScoreLabel29(score) {
  const s = LOOKUP_29.scores;
...
function getSalaryBand29(salary) {
  return LOOKUP_29.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons29() {
  return [...LOOKUP_29.reasons];
}
