/**
 * Lookup table and configuration module 06
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_06 = {
  categories: [
    { id: "cat_6_01", name: "Category A6", weight: 1.0, active: true },
    { id: "cat_6_02", name: "Category B6", weight: 1.2, active: true },
    { id: "cat_6_03", name: "Category C6", weight: 0.8, active: true },
    { id: "cat_6_04", name: "Category D6", weight: 1.5, active: false },
    { id: "cat_6_05", name: "Category E6", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory6(id) {
  return LOOKUP_06.categories.find(c => c.id === id) || null;
}

function getScoreLabel6(score) {
  const s = LOOKUP_06.scores;
...
function getSalaryBand6(salary) {
  return LOOKUP_06.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons6() {
  return [...LOOKUP_06.reasons];
}
