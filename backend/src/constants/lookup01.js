/**
 * Lookup table and configuration module 01
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_01 = {
  categories: [
    { id: "cat_1_01", name: "Category A1", weight: 1.0, active: true },
    { id: "cat_1_02", name: "Category B1", weight: 1.2, active: true },
    { id: "cat_1_03", name: "Category C1", weight: 0.8, active: true },
    { id: "cat_1_04", name: "Category D1", weight: 1.5, active: false },
    { id: "cat_1_05", name: "Category E1", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory1(id) {
  return LOOKUP_01.categories.find(c => c.id === id) || null;
}

function getScoreLabel1(score) {
  const s = LOOKUP_01.scores;
...
function getSalaryBand1(salary) {
  return LOOKUP_01.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons1() {
  return [...LOOKUP_01.reasons];
}
