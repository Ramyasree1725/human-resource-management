/**
 * Lookup table and configuration module 28
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_28 = {
  categories: [
    { id: "cat_28_01", name: "Category A28", weight: 1.0, active: true },
    { id: "cat_28_02", name: "Category B28", weight: 1.2, active: true },
    { id: "cat_28_03", name: "Category C28", weight: 0.8, active: true },
    { id: "cat_28_04", name: "Category D28", weight: 1.5, active: false },
    { id: "cat_28_05", name: "Category E28", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory28(id) {
  return LOOKUP_28.categories.find(c => c.id === id) || null;
}

function getScoreLabel28(score) {
  const s = LOOKUP_28.scores;
...
function getSalaryBand28(salary) {
  return LOOKUP_28.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons28() {
  return [...LOOKUP_28.reasons];
}
