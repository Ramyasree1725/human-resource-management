/**
 * Lookup table and configuration module 10
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_10 = {
  categories: [
    { id: "cat_10_01", name: "Category A10", weight: 1.0, active: true },
    { id: "cat_10_02", name: "Category B10", weight: 1.2, active: true },
    { id: "cat_10_03", name: "Category C10", weight: 0.8, active: true },
    { id: "cat_10_04", name: "Category D10", weight: 1.5, active: false },
    { id: "cat_10_05", name: "Category E10", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory10(id) {
  return LOOKUP_10.categories.find(c => c.id === id) || null;
}

function getScoreLabel10(score) {
  const s = LOOKUP_10.scores;
...
function getSalaryBand10(salary) {
  return LOOKUP_10.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons10() {
  return [...LOOKUP_10.reasons];
}
