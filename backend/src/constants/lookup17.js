/**
 * Lookup table and configuration module 17
 * Extensive reference data for Employee Management System.
 */

const LOOKUP_17 = {
  categories: [
    { id: "cat_17_01", name: "Category A17", weight: 1.0, active: true },
    { id: "cat_17_02", name: "Category B17", weight: 1.2, active: true },
    { id: "cat_17_03", name: "Category C17", weight: 0.8, active: true },
    { id: "cat_17_04", name: "Category D17", weight: 1.5, active: false },
    { id: "cat_17_05", name: "Category E17", weight: 1.1, active: true }
  ],
  scores: {
...
function getCategory17(id) {
  return LOOKUP_17.categories.find(c => c.id === id) || null;
}

function getScoreLabel17(score) {
  const s = LOOKUP_17.scores;
...
function getSalaryBand17(salary) {
  return LOOKUP_17.bands.find(b => salary >= b.minSalary && salary <= b.maxSalary) || null;
}

function listReasons17() {
  return [...LOOKUP_17.reasons];
}
