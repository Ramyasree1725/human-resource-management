/**
 * performanceDistributionReport Generator
...
class PerformanceDistributionReport {
  constructor() {
    this.name = 'performanceDistributionReport';
...
module.exports = new PerformanceDistributionReport();
